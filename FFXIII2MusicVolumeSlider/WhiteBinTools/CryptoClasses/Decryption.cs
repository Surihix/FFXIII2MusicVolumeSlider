...
namespace FFXIII2MusicVolumeSlider.WhiteBinTools.CryptoClasses
{
    ...
    {
        public static void DecryptBlocks(byte[] xorTable, uint blockCount, uint readPos, uint writePos, BinaryReader inFileReader, BinaryWriter decryptedStreamBinWriter)
        {
            uint blockCounter = 0;
